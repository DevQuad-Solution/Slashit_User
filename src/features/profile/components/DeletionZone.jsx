...
export function DeletionZone({ user, nav }) {
  ...
  return (
    <div style={{ paddingTop: 20, borderTop: "1px solid #f1f5f9" }}>
      ...
      >
        Requesting account deletion will disable your account. A compliance
        review will be done before permanent deletion (up to 30 days).
      </div>
      {delConfirmOpen ? (
        <div
          style={{
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              padding: "10px 12px",
              borderRadius: 10,
              border: `2px solid ${delInput === "DELETE" ? "#dc2626" : "#e2e8f0"}`,
              fontSize: 14,
              fontWeight: 700,
              letterSpacing: 2,
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              onClick={() => {
                try {
                  const reqs = JSON.parse(
                    Cookies.get("slashit_admin_deletion_requests") || "[]",
                  );
                  reqs.unshift({
                    id: "del-" + Date.now(),
                    userId: user.id,
                  ...
                  Cookies.set(
                    "slashit_admin_deletion_requests",
                    JSON.stringify(reqs),
                  );
                } catch (e) {}
              ...
              style={{
                ...
                borderRadius: 10,
                border: "none",
                background: delInput === "DELETE" ? "#dc2626" : "#e2e8f0",
                color: delInput === "DELETE" ? "#fff" : "#94a3b8",
                fontWeight: 700,
                fontSize: 13,
                cursor: delInput === "DELETE" ? "pointer" : "default",
