...
export function Referral() {
  ...
  const referralCfg = (() => {
    try {
      const r = Cookies.get("slashit_admin_referrals");
  ...
  return (
    <div style={{ background: "#f0f4ff", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          Earn {fmt(studentBonus)} (Student) or {fmt(premiumBonus)} (Premium)
          for every friend who joins and subscribes
        </div>
      </div>
      <div
        style={{
      ...
      >
        ...
        <Btn full onClick={() => toast.success("Link shared!")}>
          Share Referral Link
        </Btn>
      </div>
      <LegalFooter />
