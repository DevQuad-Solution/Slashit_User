...
function Protected({ children }) {
  ...
  if (!session.hubId) {
    let bkHub = null;
    try {
      bkHub = JSON.parse(Cookies.get("slashit_hub") || "null");
    } catch (e) {}
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={
              <Protected>
                <FlagRoute flag="hosteLeaderboard">
                  <LeaderboardPage />
                </FlagRoute>
              </Protected>
            }
          ...
          <Route
            ...
            element={
              <Protected>
                <FlagRoute flag="paidPlanPackages">
                  <SubscriptionPage />
                </FlagRoute>
              </Protected>
            }
          ...
          <Route
            ...
            element={
              <Protected>
                <FlagRoute flag="referralProgram">
                  <ReferralPage />
                </FlagRoute>
              </Protected>
            }
